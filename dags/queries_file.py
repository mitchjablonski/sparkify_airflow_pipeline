...
create_artists_table = """CREATE TABLE public.artists (
...
create_songplays_table  = """CREATE TABLE public.songplays (
...
create_songs_table = """CREATE TABLE public.songs (
...
create_staging_events_table = """CREATE TABLE public.staging_events (
    artist varchar(256),
    auth varchar(256),
...
create_staging_songs_table =  """CREATE TABLE public.staging_songs (
    num_songs int4,
...
create_time_table = """CREATE TABLE public."time" (
    start_time timestamp NOT NULL,
    "hour" int4,
    "day" int4,
    week int4,
